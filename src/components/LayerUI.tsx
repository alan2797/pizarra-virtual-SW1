...
const LayerUI = ({
  ...
  const renderCanvasActions = () => (
    ...
    >
      {/* the zIndex ensures this menu has higher stacking order,
         see https://github.com/excalidraw/excalidraw/pull/1445 */}
      <div style={{padding:5, color:'black', fontSize:20, fontWeight:'bold'}}>
        <label>ACCIONES GENERALES</label>
      </div>
      <Island padding={5}  style={{backgroundColor:'#ffa86c'}}>
        <Stack.Col gap={12}>
          <Stack.Row gap={1} justifyContent="space-between">
    ...
    return (
      <FixedSideContainer side="right">
        ...
        <div className="">
          ...
          <div style={{padding:5, color:'black', fontSize:20, fontWeight:'bold'}}>
              <label>ACCIONES PARA DIAGRAMA DE FLUJO</label>
            </div>
          {!viewModeEnabled && (
            <Section heading="shapes" >
               
              {(heading) => (
                <Stack.Col gap={1} align="start">
                  <Stack.Col gap={1}>
                    
                    <Island
                      padding={2}
                      className={clsx({ "zen-mode": zenModeEnabled })}
                      style={{backgroundColor:'#ffa86c'}}
                    >
